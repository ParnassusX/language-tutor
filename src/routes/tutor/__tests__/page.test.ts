...
describe('Language Tutor Page', () => {
  ...
  it('renders the main page with all expected elements', async () => {
    render(Page);
    expect(screen.getByText(/German Language Tutor/i)).toBeInTheDocument();
    expect(screen.getByTestId('connect-button')).toBeInTheDocument();
    await fireEvent.click(screen.getByText(/Lesson Controls/i));
    expect(screen.getByTestId('translation-button')).toBeInTheDocument();
    expect(screen.getByText('Conversation')).toBeInTheDocument();
    expect(screen.getByTestId('record-button')).toBeInTheDocument();
    await fireEvent.click(screen.getByText(/Debug Info/i));
